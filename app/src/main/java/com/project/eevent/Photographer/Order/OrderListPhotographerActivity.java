...
public class OrderListPhotographerActivity extends AppCompatActivity {
    ListView CustomList;
    Button btnSearch;
    EditText etxtSearch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_list_photographer);

        CustomList = findViewById(R.id.listView);
        btnSearch = findViewById(R.id.btnSearchOrderPhotographer);
        etxtSearch = findViewById(R.id.etxt_searchOrderPhotographer);
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (searchText.isEmpty()) {
                    Toasty.error(OrderListPhotographerActivity.this, "Please input text!", Toast.LENGTH_SHORT).show();
                } else {
                    getData(searchText);
                }
            }
    ...
    private void getData(String s) {
        ...
        String url = Constant.PHOTOGRAPHER_ORDER_LIST_URL + cell + "&text=" + getSearchText;
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        loading.dismiss();
                        Toasty.error(OrderListPhotographerActivity.this, "Network Error!", Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void showJSON(String response) {
        ...
        try {
            ...
            if (result.length() == 0) {
                Toasty.error(OrderListPhotographerActivity.this, "No Order Found!", Toast.LENGTH_SHORT).show();
                finish();
        ...
        ListAdapter adapter = new SimpleAdapter(
                OrderListPhotographerActivity.this, list, R.layout.order_list_item_photographer,
        ...
        CustomList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(OrderListPhotographerActivity.this, OrderDetailsPhotographerActivity.class);
