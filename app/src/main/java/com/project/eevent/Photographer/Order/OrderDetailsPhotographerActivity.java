package com.project.eevent.Photographer.Order;
...
public class OrderDetailsPhotographerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_details_photographer);
        ...
        txtProgramDate = findViewById(R.id.txt_program_date);
...
//        Typeface tf = Typeface.createFromAsset(getAssets(), "MachowDemo-6Yjoq.ttf");
        ...
        txtConfirmOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(OrderDetailsPhotographerActivity.this);
    ...
    public void UpdateOrder(String s) {
        ...
        String URL = Constant.UPDATE_ORDER_PHOTOGRAPHER_URL;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (getResponse.equals("success")) {
                            ...
                            Intent intent = new Intent(OrderDetailsPhotographerActivity.this, PhotographerMainActivity.class);

                            if (getStatus.equals("1"))
                                Toasty.success(OrderDetailsPhotographerActivity.this, " Order Successfully Confirmed!", Toast.LENGTH_SHORT).show();
                            else if (getStatus.equals("2"))
                                Toasty.error(OrderDetailsPhotographerActivity.this, " Order Cancel!", Toast.LENGTH_SHORT).show();
                        ...
                        //If we are getting success from server
                            ...
                            Intent intent = new Intent(OrderDetailsPhotographerActivity.this, PhotographerMainActivity.class);
                            Toast.makeText(OrderDetailsPhotographerActivity.this, " Update fail!", Toast.LENGTH_SHORT).show();
                            //startActivity(intent);

                        } else {

                            loading.dismiss();
                            Toast.makeText(OrderDetailsPhotographerActivity.this, "Network Error", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(OrderDetailsPhotographerActivity.this, "No Internet Connection or \nThere is an error !!!", Toast.LENGTH_LONG).show();
                        loading.dismiss();
                    }
                }) {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(OrderDetailsPhotographerActivity.this);
