...
public class PhotographerListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Photographer List");
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (searchText.isEmpty()) {
                    Toasty.error(PhotographerListActivity.this, "Please input Photographer name!", Toast.LENGTH_SHORT).show();
                } else {
                    getData(searchText);
                }
            }
    ...
    private void getData(String s) {
        ...
        String url = Constant.PHOTOGRAPHER_LIST_URL + "?text=" + getSearchText;
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        loading.dismiss();
                        Toasty.error(PhotographerListActivity.this, "Network Error!", Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void showJSON(String response) {
        ...
        try {
            ...
            if (result.length() == 0) {
                Toasty.error(PhotographerListActivity.this, "No Photographer Found!", Toast.LENGTH_SHORT).show();
        ...
        ListAdapter adapter = new SimpleAdapter(
                PhotographerListActivity.this, list, R.layout.photography_list_item,
        ...
        CustomList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int position, long l) {
                ...
                new AlertDialog.Builder(PhotographerListActivity.this)
                        //.setMessage("Want to Call this Shop Now?")
                        .setMessage("Choose about this Photographer")
                        .setCancelable(false)
                        ...
                        .setNegativeButton("Delete User", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                //write here
                                new androidx.appcompat.app.AlertDialog.Builder(PhotographerListActivity.this)
    ...
    public void deleteUser(final String id) {
        ...
        String URL = Constant.DELETE_PHOTOGRAPHER_URL;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (getResponse.equals("success")) {
                            ...
                            Intent intent = new Intent(PhotographerListActivity.this, AdminMainActivity.class);
                            Toasty.success(PhotographerListActivity.this, " Deleted !", Toast.LENGTH_SHORT).show();
                        ...
                        //If we are getting success from server
                            ...
                            Toast.makeText(PhotographerListActivity.this, "Delete fail!", Toast.LENGTH_SHORT).show();
                            //startActivity(intent);

                        } else {

                            loading.dismiss();
                            Toast.makeText(PhotographerListActivity.this, "Network Error", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(PhotographerListActivity.this, "No Internet Connection or \nThere is an error !!!", Toast.LENGTH_LONG).show();
                        loading.dismiss();
                    }
                }) {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(PhotographerListActivity.this);
        requestQueue.add(stringRequest);
