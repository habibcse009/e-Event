...
public class EdListActivity extends AppCompatActivity {
    ListView CustomList;
    Button btnSearch;
    EditText etxtSearch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Event Decorator List");
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (searchText.isEmpty()) {
                    Toasty.error(EdListActivity.this, "Please input Event Decorator name!", Toast.LENGTH_SHORT).show();
                } else {
                    getData(searchText);
                }
            }
    ...
    private void getData(String s) {
        ...
        String url = Constant.ED_LIST_URL + "?text=" + getSearchText;
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        loading.dismiss();
                        Toasty.error(EdListActivity.this, "Network Error!", Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void showJSON(String response) {
        ...
        try {
            ...
            if (result.length() == 0) {
                Toasty.error(EdListActivity.this, "No Event Decorator Found!", Toast.LENGTH_SHORT).show();
        ...
        ListAdapter adapter = new SimpleAdapter(
                EdListActivity.this, list, R.layout.ed_list_item,
        ...
        CustomList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int position, long l) {
                ...
                new AlertDialog.Builder(EdListActivity.this)
                        //.setMessage("Want to Call this Shop Now?")
                        .setMessage("Choose about this Event Decorator")
                        .setCancelable(false)
                        ...
                        .setNegativeButton("Delete User", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                //write here
                                new androidx.appcompat.app.AlertDialog.Builder(EdListActivity.this)
    ...
    public void deleteUser(final String id) {
        ...
        String URL = Constant.DELETE_ED_URL;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (getResponse.equals("success")) {
                            ...
                            Intent intent = new Intent(EdListActivity.this, AdminMainActivity.class);
                            Toasty.success(EdListActivity.this, " Deleted !", Toast.LENGTH_SHORT).show();
                        ...
                        //If we are getting success from server
                            ...
                            Toast.makeText(EdListActivity.this, "Delete fail!", Toast.LENGTH_SHORT).show();
                            //startActivity(intent);

                        } else {

                            loading.dismiss();
                            Toast.makeText(EdListActivity.this, "Network Error", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(EdListActivity.this, "No Internet Connection or \nThere is an error !!!", Toast.LENGTH_LONG).show();
                        loading.dismiss();
                    }
                }) {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(EdListActivity.this);
        requestQueue.add(stringRequest);
