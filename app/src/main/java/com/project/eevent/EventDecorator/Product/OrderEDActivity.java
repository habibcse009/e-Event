...
public class OrderEDActivity extends AppCompatActivity {
    ...
    String name, id, price, getPrice, program_date, address, cus_cell, ed_cell, bkash_tex;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_e_d);

        getSupportActionBar().setTitle("Order Panel");
        getSupportActionBar().setHomeButtonEnabled(true); //for back button
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);//for back button

        txtName = findViewById(R.id.txt_product_nameED_order);
        txtPrice = findViewById(R.id.txt_product_priceED_order);
        txtProgramDate = findViewById(R.id.txt_programDateED_order);
        btnOrderSubmit = findViewById(R.id.txt_submit_orderED_order);
...
//        btnPlus = findViewById(R.id.btn_plus);
        ...
        etxtFullAddress = findViewById(R.id.etxt_full_addressED_order);
        etxBkashTexID = findViewById(R.id.etx_bkash_txtIDED_order);
       ...
       /* rbCashOnDelivery = findViewById(R.id.rb_cash_on_delivery);
        ...
        txtProgramDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new DatePickerDialog(OrderEDActivity.this, date, myCalendar
...
//
        loading = new ProgressDialog(OrderEDActivity.this);
        loading.setMessage("Please wait....");
        loading.show();

        //Creating a string request
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constant.ORDER_SUBMIT_ED_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (myResponse.equals("success")) {
                            ...
                            Intent intent = new Intent(OrderEDActivity.this, CusMainActivity.class);
                            Toasty.success(OrderEDActivity.this, "Order successful", Toast.LENGTH_SHORT).show();
                            startActivity(intent);

                        } else if (myResponse.equalsIgnoreCase(Constant.USER_EXISTS)) {

                            Toasty.error(OrderEDActivity.this, "Program date already booked!\nPlease select another date.", Toast.LENGTH_SHORT).show();
                            loading.dismiss();
                        ...
                        if (myResponse.equals("failure")) {
                            ...
                            Toasty.success(OrderEDActivity.this, "Order failed!", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toasty.error(OrderEDActivity.this, "Error in connection!", Toast.LENGTH_LONG).show();
                        // loading.dismiss();
                    }
                }) {
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(Constant.KEY_ED_CELL, ed_cell);
