...
public class CusOrderListChActivity extends AppCompatActivity {
    ListView CustomList;
    Button btnSearch;
    EditText etxtSearch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cus_order_list_ch);
        CustomList = findViewById(R.id.listViewCH_Cus);
        btnSearch = findViewById(R.id.btnSearchOrderCH_Cus);
        etxtSearch = findViewById(R.id.etxt_searchOrderCH_Cus);


        getSupportActionBar().setHomeButtonEnabled(true); //for back button
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);//for back button
        getSupportActionBar().setTitle("My Convention Hall Order List");
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (searchText.isEmpty()) {
                    Toasty.error(CusOrderListChActivity.this, "Please input text!", Toast.LENGTH_SHORT).show();
                } else {
                    getData(searchText);
                }
            }
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        loading.dismiss();
                        Toasty.error(CusOrderListChActivity.this, "Network Error!", Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void showJSON(String response) {
        ...
        try {
            ...
            if (result.length() == 0) {
                Toasty.error(CusOrderListChActivity.this, "No Order Found!", Toast.LENGTH_SHORT).show();
                finish();
        ...
        ListAdapter adapter = new SimpleAdapter(
                CusOrderListChActivity.this, list, R.layout.order_list_item_ch,
        ...
        CustomList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                if (mStatus[position].equals("1")) {
                  ...
                  */
                    Toasty.info(CusOrderListChActivity.this, "Your order is confirmed", Toast.LENGTH_SHORT).show();


                } else if (mStatus[position].equals("2")) {
                    Toasty.info(CusOrderListChActivity.this, "Your order is canceled", Toast.LENGTH_SHORT).show();
                } else {
                    Toasty.info(CusOrderListChActivity.this, "Your order is pending", Toast.LENGTH_SHORT).show();
                }
            }
