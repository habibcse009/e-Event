...
public class CusOrderListEdActivity extends AppCompatActivity {
    ListView CustomList;
    Button btnSearch;
    EditText etxtSearch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cus_order_list_ed);
        CustomList = findViewById(R.id.listViewOrderED_Cus);
        btnSearch = findViewById(R.id.btnSearchOrderOrderED_Cus);
        etxtSearch = findViewById(R.id.etxt_searchOrderOrderED_Cus);


        getSupportActionBar().setHomeButtonEnabled(true); //for back button
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);//for back button
        getSupportActionBar().setTitle("My Event Decorator Order List");
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (searchText.isEmpty()) {
                    Toasty.error(CusOrderListEdActivity.this, "Please input text!", Toast.LENGTH_SHORT).show();
                } else {
                    getData(searchText);
                }
            }
    ...
    private void getData(String s) {
        ...
        String url = Constant.ORDER_LIST_URL_ED + cell + "&text=" + getSearchText;
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        loading.dismiss();
                        Toasty.error(CusOrderListEdActivity.this, "Network Error!", Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void showJSON(String response) {
        ...
        try {
            ...
            if (result.length() == 0) {
                Toasty.error(CusOrderListEdActivity.this, "No Order Found!", Toast.LENGTH_SHORT).show();
                finish();
        ...
        ListAdapter adapter = new SimpleAdapter(
                CusOrderListEdActivity.this, list, R.layout.order_list_item_ed,
        ...
        CustomList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                if (mStatus[position].equals("1")) {
                  /*  Intent intent = new Intent(CusOrderListEdActivity.this, ReviewActivity.class);
                    intent.putExtra("id", mId[position]);
                    startActivity(intent);
                  */
                    Toasty.info(CusOrderListEdActivity.this, "Your order is confirmed", Toast.LENGTH_SHORT).show();


                } else if (mStatus[position].equals("2")) {
                    Toasty.info(CusOrderListEdActivity.this, "Your order is canceled", Toast.LENGTH_SHORT).show();
                } else {
                    Toasty.info(CusOrderListEdActivity.this, "Your order is pending", Toast.LENGTH_SHORT).show();
                }
            }
