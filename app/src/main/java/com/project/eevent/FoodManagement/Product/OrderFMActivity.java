...
public class OrderFMActivity extends AppCompatActivity {
    ...
    String name, id, price, getPrice, program_date, address, cus_cell, fm_cell, bkash_tex;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_f_m);

        getSupportActionBar().setTitle("Order Panel");
        getSupportActionBar().setHomeButtonEnabled(true); //for back button
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);//for back button

        txtName = findViewById(R.id.txt_product_nameFM_order);
        txtPrice = findViewById(R.id.txt_product_priceFM_order);
        txtProgramDate = findViewById(R.id.txt_programDateFM_order);
        btnOrderSubmit = findViewById(R.id.txt_submit_orderFM_order);
...
//        btnPlus = findViewById(R.id.btn_plus);
        ...
        etxtFullAddress = findViewById(R.id.etxt_full_addressFM_order);
        etxBkashTexID = findViewById(R.id.etx_bkash_txtIDFM_order);
       ...
       /* rbCashOnDelivery = findViewById(R.id.rb_cash_on_delivery);
        ...
        txtProgramDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new DatePickerDialog(OrderFMActivity.this, date, myCalendar
...
//
        loading = new ProgressDialog(OrderFMActivity.this);
        loading.setMessage("Please wait....");
        loading.show();

        //Creating a string request
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constant.ORDER_SUBMIT_FM_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (myResponse.equals("success")) {
                            ...
                            Intent intent = new Intent(OrderFMActivity.this, CusMainActivity.class);
                            Toasty.success(OrderFMActivity.this, "Order successful", Toast.LENGTH_SHORT).show();
                            startActivity(intent);

                        } else if (myResponse.equalsIgnoreCase(Constant.USER_EXISTS)) {

                            Toasty.error(OrderFMActivity.this, "Program date already booked!\nPlease select another date.", Toast.LENGTH_SHORT).show();
                            loading.dismiss();
                        ...
                        if (myResponse.equals("failure")) {
                            ...
                            Toasty.success(OrderFMActivity.this, "Order failed!", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toasty.error(OrderFMActivity.this, "Error in connection!", Toast.LENGTH_LONG).show();
                        // loading.dismiss();
                    }
                }) {
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(Constant.KEY_FM_CELL, fm_cell);
