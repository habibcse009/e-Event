...
public class OrderListFMActivity extends AppCompatActivity {
    ListView CustomList;
    Button btnSearch;
    EditText etxtSearch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_list_f_m);
        CustomList = findViewById(R.id.listViewFM);
        btnSearch = findViewById(R.id.btnSearchOrderFM);
        etxtSearch = findViewById(R.id.etxt_searchOrderFM);
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (searchText.isEmpty()) {
                    Toasty.error(OrderListFMActivity.this, "Please input text!", Toast.LENGTH_SHORT).show();
                } else {
                    getData(searchText);
                }
            }
    ...
    private void getData(String s) {
        ...
        String url = Constant.FM_ORDER_LIST_URL + cell + "&text=" + getSearchText;
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        loading.dismiss();
                        Toasty.error(OrderListFMActivity.this, "Network Error!", Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void showJSON(String response) {
        ...
        try {
            ...
            if (result.length() == 0) {
                Toasty.error(OrderListFMActivity.this, "No Order Found!", Toast.LENGTH_SHORT).show();
                finish();
        ...
        ListAdapter adapter = new SimpleAdapter(
                OrderListFMActivity.this, list, R.layout.order_list_item_fm,
        ...
        CustomList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(OrderListFMActivity.this, OrderDetailsFMActivity.class);
