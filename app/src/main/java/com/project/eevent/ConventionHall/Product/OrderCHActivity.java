package com.project.eevent.ConventionHall.Product;
...
public class OrderCHActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtPrice = findViewById(R.id.txt_product_priceCH);
        txtProgramDate = findViewById(R.id.txt_programDateCH);
        btnOrderSubmit = findViewById(R.id.txt_submit_orderCH);
...
//        btnPlus = findViewById(R.id.btn_plus);
        ...
        etxtFullAddress = findViewById(R.id.etxt_full_addressCH);
        etxBkashTexID = findViewById(R.id.etx_bkash_txtIDCH);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (myResponse.equals("success")) {
                            ...
                            Intent intent = new Intent(OrderCHActivity.this, CusMainActivity.class);
